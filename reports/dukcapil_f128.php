...
LEFT OUTER JOIN t_dukcapil_f128 c ON a.penduduk_detail_id = c.penduduk_detail_id
  ...
  <tr>
    ...
    <td width="13%"> <div align="center">
      <table width="100%"  border="1">
        <tr>
          <td bordercolor="#000000"><div align="center"><strong>F-1.28</strong></div></td>
        </tr>
      </table>
    </div></td>
  </tr>
...
<div align="center">
  <table width="100%" border="0">
	...
	{
?>
        <div align="center"><span class="style7">PEMERINTAH KABUPATEN PURWOREJO</span><span class="style1"><br>
            <span class="style6">DINAS KEPENDUDUKAN DAN CATATAN SIPIL</span><br>
        </span><span class="style7">JLN TENTARA PELAJAR PURWOREJO</span></div></td>
    </tr>
  </table>
</div>
...
<table border=0 class="header" style="width: 100%;">
  <tr>
    ...
    <td width="8%" bordercolor="#000000">&nbsp;</td>
    <td width="41%" bordercolor="#000000" class="kotak">JAWA TENGAH </td>
  <tr>
...
<table width="100%" border="0">
  <tr>
    <td width="100%" colspan="2"><p align="center"><span class="style1">SURAT KETERANGAN PINDAH DATANG WNI<br>
    </span><span class="style4">      Antar Desa/Kelurahan Dalam Satu Kecamatan<br>
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="3%">RW:</td>
    <td width="17%" class="kotak"><?php echo $hasil['rw_asal']; ?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="17%" class="kotak"><?php echo $hasil['desa_kelurahan_asal']; ?></td>
    <td width="3%">&nbsp;</td>
...
<table border=0 class="header" style="width: 100%;">
  <tr>
    <td colspan="3" bordercolor="#000000">DATA DAERAH TUJUAN </td>
  <tr>
    <td width="27%" bordercolor="#000000">1. Status Nomor KK<br></td>
    <td width="18%" bordercolor="#000000" class="kotak"><?php echo $hasil['status_nomor_kk_bagi_yang_pindah']; ?></td>
    <td width="55%" bordercolor="#000000">&nbsp;</td>
  <tr>
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="3%">RW:</td>
    <td width="18%" class="kotak"><?php echo $hasil['rw']; ?></td>
  </tr>
  <tr>

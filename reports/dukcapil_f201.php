...
LEFT OUTER JOIN t_dukcapil_f201 c ON a.penduduk_detail_id = c.penduduk_detail_id
  ...
  <tr>
    ...
    <td width="13%"> <div align="center">
      <table width="100%"  border="1">
        <tr>
          <td bordercolor="#000000"><div align="center"><strong>F-2.01</strong></div></td>
        </tr>
      </table>
    </div></td>
  </tr>
...
<table width="100%" border="0">
  <tr>
    <td width="100%" colspan="2"><p align="center"><span class="style1">SURAT KETERANGAN KELAHIRAN<br>
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td width="1%">:</td>
    <td width="73%"><?php echo $hasil['nama_bayi']; ?></td>
  </tr>
  <tr>
    <td>2. Jenis Kelamin </td>
    <td>:</td>
    <td><?php echo $hasil['jenis_kelamin_bayi']; ?></td>
  </tr>
  <tr>
    <td>3. Tempat Dilahirkan</td>
    <td>:</td>
    <td><?php echo $hasil['tempat_dilahirkan']; ?></td>
  </tr>
  <tr>
    <td>4. Tempat Kelahiran</td>
    <td width="1%">:</td>
    <td width="73%"><?php echo $hasil['tempat_kelahiran']; ?></td>
  </tr>
  <tr>
    <td>5. Tanggal Lahir dan Hari </td>
    <td>:</td>
    <td><?php echo $hasil['tanggal_lahir_dan_hari']; ?></td>
  </tr>
  <tr>
    <td>6. Pukul  </td>
    <td>:</td>
    <td><?php echo $hasil['jam_kelahiran']; ?></td>
  </tr>
  <tr>
    <td>7. Jenis Kelahiran </td>
    <td>:</td>
    <td><?php echo $hasil['jenis_kelahiran']; ?></td>
  </tr>
  <tr>
    <td>8. Kelahiran Ke </td>
    <td>:</td>
    <td><?php echo $hasil['kelahiran_ke']; ?></td>
  </tr>
  <tr>
    <td>9. Penolong Kelahiran </td>
    <td>:</td>
    <td><?php echo $hasil['penolong_kelahiran']; ?></td>
  </tr>
  <tr>
    <td>10. Berat Bayi </td>
    <td>:</td>
    <td><?php echo $hasil['berat_bayi']; ?></td>
  </tr>
  <tr>
    <td>11. Panjang Bayi </td>
    <td>:</td>
    <td><?php echo $hasil['panjang_bayi']; ?></td>
  </tr>
</table>
<?php
$query2 = "
SELECT b.* 
FROM t_dukcapil_f201 as a
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td>:</td>
    <td><?php if ($hasil2['nama_lengkap'] <> '' ) { echo $hasil2['tanggal_lahir']; }  else {echo $hasil['tanggal_lahir_umur_orang_tua'] ; } ?>/<?php echo $hasil['umur_ibu']; ?></td>
  </tr>
  <tr>
    <td>4. Pekerjaan </td>
    <td>:</td>
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td colspan="5">: <?php if ($hasil2['nama_lengkap'] <> '' ) { echo $hasil2['alamat']; }  else {echo $hasil['alamat_orang_tua'] ; } ?></td>
  </tr>
  <tr>
    <td width="19%">a. Desa/Kelurahan</td>
    <td width="17%">: <?php if ($hasil2['nama_lengkap'] <> '' ) { echo $hasil['desa']; }  else {echo $hasil['desa_orang_tua'] ; } ?></td>
    <td width="3%">&nbsp;</td>
    <td width="14%">b. Kecamatan</td>
    <td colspan="2">; <?php if ($hasil2['nama_lengkap'] <> '' ) { echo $hasil['kec']; }  else {echo $hasil['kecamatan_orang_tua'] ; } ?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Kode Pos</td>
    <td>: <?php if ($hasil2['nama_lengkap'] <> '' ) { echo $hasil['kode_pos']; }  else {echo $hasil['kode_pos_orang_tua'] ; } ?></td>
    <td>&nbsp;</td>
    <td>Telepon</td>
    <td colspan="2">: <?php if ($hasil2['nama_lengkap'] <> '' ) { echo $hasil['telp']; }  else {echo $hasil['telp_orang_tua'] ; } ?></td>
  </tr>
</table>
<table width="100%" border="0">
...
?>
  ...
  <tr>
    <td>3. Tanggal Lahir/Umur </td>
    <td>:</td>
    <td><?php if ($hasil3['nama_lengkap'] <> '' ) { echo $hasil3['tanggal_lahir']; }  else {echo $hasil['tanggal_lahir_umur_orang_tua'] ; } ?>/<?php echo $hasil['umur_ayah']; ?></td>
  </tr>
  <tr>
    <td>4. Pekerjaan </td>
    <td>:</td>
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td width="1%" rowspan="4">&nbsp;</td>
    <td>Dusun/Dukuh/Kampung</td>
    <td colspan="5">: <?php if ($hasil3['nama_lengkap'] <> '' ) { echo $hasil3['alamat']; }  else {echo $hasil['alamat_orang_tua'] ; } ?></td>
  </tr>
  <tr>
    <td width="19%">a. Desa/Kelurahan</td>
    <td width="17%">: <?php if ($hasil3['nama_lengkap'] <> '' ) { echo $hasil['desa']; }  else {echo $hasil['desa_orang_tua'] ; } ?></td>
    <td width="3%">&nbsp;</td>
    <td width="14%">b. Kecamatan</td>
    <td colspan="2">: <?php if ($hasil3['nama_lengkap'] <> '' ) { echo $hasil['kec']; }  else {echo $hasil['kecamatan_orang_tua'] ; } ?></td>
  </tr>
  <tr>
    <td>c. Kabupaten/Kota</td>
    <td>: Purworejo</td>
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td>Dusun/Dukuh/Kampung</td>
    <td colspan="5">: <?php if ($hasil4['nama_lengkap'] <> '' ) { echo $hasil4['alamat']; }  else {echo $hasil['alamat_pelapor'] ; } ?></td>
  </tr>
  <tr>
    <td width="19%">a. Desa/Kelurahan</td>
    <td width="17%">: <?php if ($hasil4['nama_lengkap'] <> '' ) { echo $hasil['desa']; }  else {echo $hasil['desa_pelapor'] ; } ?></td>
    <td width="3%">&nbsp;</td>
    <td width="14%">b. Kecamatan</td>
    <td colspan="2">: <?php if ($hasil4['nama_lengkap'] <> '' ) { echo $hasil['kec']; }  else {echo $hasil['kecamatan_pelapor'] ; } ?></td>
  </tr>
  <tr>
    <td>c. Kabupaten/Kota</td>
    <td>: Purworejo </td>
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td width="1%" rowspan="3">&nbsp;</td>
    <td>Dusun/Dukuh/Kampung</td>
    <td colspan="5">: <?php if ($hasil5['nama_lengkap'] <> '' ) { echo $hasil5['alamat']; }  else {echo $hasil['alamat_saksi1'] ; } ?></td>
  </tr>
  <tr>
    <td width="19%">a. Desa/Kelurahan</td>
    <td width="17%">: <?php if ($hasil5['nama_lengkap'] <> '' ) { echo $hasil['desa']; }  else {echo $hasil['desa_saksi1'] ; } ?></td>
    <td width="3%">&nbsp;</td>
    <td width="15%">b. Kecamatan</td>
    <td colspan="2">: <?php if ($hasil5['nama_lengkap'] <> '' ) { echo $hasil['kec']; }  else {echo $hasil['kecamatan_saksi1'] ; } ?></td>
  </tr>
  <tr>
    <td>c. Kabupaten/Kota</td>
    <td>: Purworejo </td>
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td width="1%" rowspan="3">&nbsp;</td>
    <td>Dusun/Dukuh/Kampung</td>
    <td colspan="5">: <?php if ($hasil6['nama_lengkap'] <> '' ) { echo $hasil6['alamat']; }  else {echo $hasil['alamat_saksi2'] ; } ?></td>
  </tr>
  <tr>
    <td width="19%">a. Desa/Kelurahan</td>
    <td width="17%">: <?php if ($hasil6['nama_lengkap'] <> '' ) { echo $hasil['desa']; }  else {echo $hasil['desa_saksi2'] ; } ?></td>
    <td width="3%">&nbsp;</td>
    <td width="16%">b. Kecamatan</td>
    <td colspan="2">: <?php if ($hasil6['nama_lengkap'] <> '' ) { echo $hasil['kec']; }  else {echo $hasil['kecamatan_saksi2'] ; } ?></td>
  </tr>
  <tr>
    <td>c. Kabupaten/Kota</td>
    <td>: Purworejo </td>
...
<table width="100%"  border="0">
  ...
  <tr>
    ...
    <td width="40%" bordercolor="#000000"><p align="center"><?php echo $hasil['desa']; ?>, ....................20....</p>
      ...
      <p align="center">&nbsp;</p>
      <p align="center">&nbsp;</p>
      <p align="center"><u>(<?php echo $hasil['nama_pemohon']; ?>)</u></p>
      <p align="center"><br>
      </p></td>
  </tr>
</table>

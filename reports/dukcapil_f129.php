...
LEFT OUTER JOIN t_dukcapil_f129 c ON a.penduduk_detail_id = c.penduduk_detail_id
  ...
  <tr>
    ...
    <td width="13%"> <div align="center">
      <table width="100%"  border="1">
        <tr>
          <td bordercolor="#000000"><div align="center"><strong>F-1.29</strong></div></td>
        </tr>
      </table>
    </div></td>
  </tr>
...
<table width="100%" border="0">
  <tr>
    <td width="43%"><p align="center"><span class="style1">FORMULIR PERMOHONAN   PINDAH WNI<br>
      </span><span class="style3">Antar Kecamatan Dalam Satu Kabupaten/Kota<br>
      </span>No. <?php echo $hasil['nomor_surat']; ?><br>
      <br>
    </p>    </td>
  </tr>
</table>
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="3%">RW:</td>
    <td width="16%" class="kotak"><?php echo $hasil['rw']; ?></td>
  </tr>
  <tr>
...
<table border=0 class="header" style="width: 100%;">
  ...
  <tr>
    ...
    <td width="17%" bordercolor="#000000" class="kotak"><?php echo $hasil['alasan_pindah']; ?></td>
...
<table width="100%" border="0">
  ...
  <tr>
    <td width="19%">a. Desa/Kelurahan</td>
    <td width="18%" class="kotak"><?php echo $hasil['desa_kelurahan_pindah']; ?></td>
    <td width="3%">&nbsp;</td>
    <td width="14%">b. Kecamatan</td>
...
<table border=0 class="header" style="width: 100%;">
  ...
  <tr>
    ...
    <td width="19%" bordercolor="#000000" class="kotak"><?php echo $hasil['status_kk_bagi_yang_tidak_pindah']; ?></td>
...
<table width="100%"  border="0">
  ...
  <tr>
    <td width="37%" bordercolor="#000000"><p align="center">&nbsp;</p>
      <p align="center">Petugas Regristrasi,</p>
      <p align="center">&nbsp;</p>

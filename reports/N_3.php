...
LEFT OUTER JOIN model_n3 c ON a.penduduk_detail_id = c.penduduk_detail_id
  ...
  <tr>
    <td width="15%"> <div align="center">
      <table width="100%"  border="0">
        <tr>
          <td bordercolor="#000000"><div align="right"><strong>Model N - 3 </strong></div></td>
        </tr>
      </table>
    </div></td>
  </tr>
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td>:</td>
    <td><?php if ($hasil2['nama_lengkap'] <> '' ) { echo $hasil2['nama_lengkap']; }  else {echo $hasil['nama_calon'] ; } ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>2. Bin</td>
  ...
  <tr>
    <td width="3%">&nbsp;</td>
    <td width="33%">3. Tempat dan Tanggal Lahir </td>
    <td width="1%">:</td>
    <td width="63%"><?php if ($hasil2['nama_lengkap'] <> '' ) { echo $hasil2['tempat_lahir']; }  else {echo $hasil['tempat_lahir_calon'] ; } ?>
    , 
    <?php if ($hasil2['nama_lengkap'] <> '' ) { echo $hasil2['tanggal_lahir']; }  else {echo $hasil['tanggal_lahir_calon'] ; } ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>4. Warganegara </td>
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="3%">RT:</td>
    <td width="8%"><?php if ($hasil2['nama_lengkap'] <> '' ) { echo $hasil2['rt']; }  else {echo $hasil['rt_calon'] ; } ?></td>
    <td width="3%">RW:</td>
    <td width="19%"><?php if ($hasil2['nama_lengkap'] <> '' ) { echo $hasil2['rw']; }  else {echo $hasil['rw_calon'] ; } ?></td>
  </tr>
</table>
<?php
$query3 = "
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td>1. Nama Lengkap dan Alias</td>
    <td>:</td>
    <td><?php if ($hasil3['nama_lengkap'] <> '' ) { echo $hasil3['nama_lengkap']; }  else {echo $hasil['nama_calon'] ; } ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>2. Binti</td>
  ...
  <tr>
    ...
    <td width="33%">3. Tempat dan Tanggal Lahir </td>
    <td width="1%">:</td>
    <td width="63%"><?php if ($hasil3['nama_lengkap'] <> '' ) { echo $hasil3['tempat_lahir']; }  else {echo $hasil['tempat_lahir_calon'] ; } ?>, 
    <?php if ($hasil3['nama_lengkap'] <> '' ) { echo $hasil3['tanggal_lahir']; }  else {echo $hasil['tanggal_lahir_calon'] ; } ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>4. Warganegara </td>
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="3%">RT:</td>
    <td width="8%"><?php if ($hasil3['nama_lengkap'] <> '' ) { echo $hasil3['rt']; }  else {echo $hasil['rt_calon'] ; } ?></td>
    <td width="3%">RW:</td>
    <td width="19%"><?php if ($hasil3['nama_lengkap'] <> '' ) { echo $hasil3['rw']; }  else {echo $hasil['rw_calon'] ; } ?></td>
  </tr>
</table>
...
<table width="100%"  border="0">
  ...
  <tr>
    ...
    <td width="42%" bordercolor="#000000"><p align="center"><?php echo $hasil['desa']; ?>, ....................20....</p>
      ...
      <p align="center">&nbsp;</p>
      <p align="center"><u>(
        <?php if ($hasil3['nama_lengkap'] <> '' ) { echo $hasil3['nama_lengkap']; }  else {echo $hasil['nama_calon'] ; } ?>
        )</u><br>
    </p></td>
  </tr>
</table>

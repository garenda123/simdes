...
LEFT OUTER JOIN t_surat_pengantar_umum c ON a.penduduk_detail_id = c.penduduk_detail_id
...
<table width="100%" border="0">
      ...
      <table width="100%" border="0">
        <tr>
          <td><table width="100%" border="0">
            <tr>
              <td><div align="center"><strong><u>SURAT PENGANTAR <br />
  ...
  <tr>
    ...
    <td width="35%">Jk : <?php echo $hasil['jenis_kelamin']; ?></td>
  </tr>
  <tr>
    <td>2. Tempat dan tanggal lahir </td>
    <td>:</td>
    <td colspan="2"><?php echo $hasil['tempat_lahir']; ?>  <?php date_default_timezone_set("Asia/Jakarta"); echo date( 'd-m-Y', strtotime($hasil['tanggal_lahir'] ));  ?></td>
    </tr>
  <tr>
    <td>3. Warganegara</td>
    <td>:</td>
  ...
  <tr>
    <td>8. Keperluan </td>
    <td>:</td>
    <td colspan="2"><?php echo $hasil['keperluan']; ?></td>
    </tr>
  <tr>
    <td>9. Berlaku </td>
    <td>:</td>
    <td colspan="2"><?php echo $hasil['berlaku']; ?></td>
    </tr>
  <tr>
...
<table width="100%"  border="0">
  <tr>
    ...
    <td width="50%" bordercolor="#000000"><p align="center"><?php echo $hasil['desa']; ?>, ....................20....</p>
        <p align="center">Lurah <?php echo $hasil['desa']; ?></p>
        <p align="center">&nbsp;</p>

...
LEFT OUTER JOIN t_dukcapil_f209 c ON a.penduduk_detail_id = c.penduduk_detail_id
  ...
  <tr>
    ...
    <td width="13%"> <div align="center">
      <table width="100%"  border="1">
        <tr>
          <td bordercolor="#000000"><div align="center"><strong>F-2.09</strong></div></td>
        </tr>
      </table>
    </div></td>
  </tr>
...
<table width="100%" border="0">
  <tr>
    <td width="100%" colspan="2"><p align="center"><span class="style1">SURAT KETERANGAN LAHIR MATI<br>
...
<table width="100%" border="0">
  ...
  <tr>
    <td width="26%">1. Lama Dalam Kandungan </td>
    <td width="1%">:</td>
    <td width="73%"><?php echo $hasil['lama_dalam_kandungan']; ?> Bulan </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>:</td>
    <td><?php echo $hasil['tanggal_lahir_bayi']; ?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>5. Anak Ini Lahir Yang Ke </td>
    <td>:</td>
    <td><?php echo $hasil['lahir_yang_ke']; ?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>:</td>
    <td><?php echo $hasil['sebab_lahir_mati']; ?></td>
  </tr>
  <tr>
    <td>9. Yang Menentukan </td>
    <td>:</td>
    <td><?php echo $hasil['yang_menentukan']; ?></td>
  </tr>
  <tr>
    <td>10. Tempat Kelahiran </td>
    <td>:</td>
    <td><?php echo $hasil['tempat_kelahiran']; ?></td>
  </tr>
</table>
<?php
$query2 = "
SELECT b.* 
FROM t_dukcapil_f209 as a

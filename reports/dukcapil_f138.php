...
LEFT OUTER JOIN vw_m_penduduk b ON a.nik = b.nik
LEFT OUTER JOIN t_dukcapil_f138 c ON a.penduduk_detail_id = c.penduduk_detail_id
...
<html>
<head><link rel="STYLESHEET" href="cetak.css" type="text/css" />
</head>
  ...
  <tr>
    ...
    <td width="13%"> <div align="center">
      <table width="100%"  border="1">
        <tr>
          <td bordercolor="#000000"><div align="center"><strong>F-1.38</strong></div></td>
        </tr>
      </table>
    </div></td>
  </tr>
...
<table border=0 class="header" style="width: 100%;">
  <tr>
    <td width="40%" bordercolor="#000000">PROPINSI</td>
    <td width="3%" bordercolor="#000000">:</td>
    <td width="5%" bordercolor="#000000" class="kotak"><?php echo $hasil['prop_id']; ?></td>
...
<table width="100%" border="0">
  <tr>
    ...
    </span><span class="style3">Antar  Kabupaten/Kota atau Antar Provinsi <br>
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td class="kotak"><?php echo $hasil['kabupaten_asal']; ?></td>
    <td>&nbsp;</td>
    <td>d. Provinsi</td>
    <td colspan="2" class="kotak"><?php echo $hasil['provinsi_asal']; ?></td>
  </tr>
  <tr>
    <td>Kode Pos</td>
...
<table border=0 class="header" style="width: 100%;">
  <tr>
    ...
    <td width="17%" bordercolor="#000000" class="kotak"><?php echo $hasil['status_nomor_kk_bagi_yang_pindah']; ?></td>
    <td width="56%" bordercolor="#000000">&nbsp;</td>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2" bordercolor="#000000" class="kotak"><?php echo $hasil['tanggal_kedatangan']; ?></td>
</table>
<table width="100%" border="0">
  <tr>
    <td>6. Alamat </td>
...
<table width="100%"  border="0">
  ...
  <tr>
    <td width="60%" bordercolor="#000000"><p align="center">Petugas Regristrasi</p>
      <p align="center">&nbsp;</p>
      <p align="center">&nbsp;</p>
    <p align="center"><u>(...........................................)</u> </p></td>
    <td width="60%" bordercolor="#000000"><p align="center">Mengetahui :</p>
...
<p>-Lembar 1 dibawa oleh pemohon dan diarsipkan di Kecamatan.<br>
  -Lembar 2 untuk pemohon.<br>
  -Lembar 3 diarsipkan di Desa/Kelurahan.
</p>
<?php
	}
?>
